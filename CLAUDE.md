...
These instructions apply to Claude Code and other repository-aware coding agents working in this repository.
...
- Keep this file aligned with `AGENTS.md` so Claude-oriented and Codex-oriented tooling follow the same repository rules.
- If the two files ever diverge, update them together.
